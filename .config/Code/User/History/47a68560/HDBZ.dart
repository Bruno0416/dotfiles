...
class _SpotifyWidgetState extends State<SpotifyWidget> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                _buildBtn(
                  ...
                  color: textColor, textColor:  textColor.withAlpha(100),
                  size: 28,
            ...
            IconButton(
                ...
                _buildBtn(
                  ...
                  color: _loopStatus != "None" ? accentColor : textColor, textColor:  textColor.withAlpha(100),
                  size: 20,
  ...
  Widget _buildBtn({required IconData icon, required Color color, required double size, required VoidCallback onTap, required Color textColor}) {
    return IconButton(
