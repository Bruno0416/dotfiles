...
class _SpotifyWidgetState extends State<SpotifyWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final primary = walColors['color2'] ?? AppColors.primary;
    // final accentColor =
    //     walColors['color3'] ??
    //     AppColors.accent;
    ...
    return Scaffold(
      backgroundColor: bgColor.withAlpha(180),
      body: Padding(
            ...
            Row(
              ...
              children: [
                _buildBtn(
                  ...
                  color: _isShuffle ? primary : textColor,
                ...
                _buildBtn(
                  ...
                  color: _loopStatus != "None" ? primary : textColor,
                  textColor: textColor.withAlpha(100),
                  size: 20,
                  onTap: () => _sendCommand([
                    'loop',
